...
public class PizzaBestellung extends JFrame {
    ...
    private ArrayList<Pizza> bestellung = new ArrayList<>();
    ...
    public void hinzufuegen() {
        try {
            ...
            Pizza p = new Pizza(pizzaSorten, belag1, belag2, groesse, preis, menge);
            bestellung.add(p);
    ...
    public double getPizzaPreis(String sorte) {
        switch (sorte) {
            case "Margherita": return 11.0;
            case "Tonno": return 13.0;
            case "Hawaii": return 13.5;
            case "Frutti di Mare": return 15.0;
           default: throw new IllegalArgumentException("Bitte wählen Sie eine Sorte aus.");
        }
    }
    ...
    public double getGroessePreis(char groesse) {
        switch (groesse) {
            ...
            case 'M': return 1.0;
            case 'L': return 2.0;
            default: throw new IllegalArgumentException("Bitte wählen Sie eine Größe aus.");
        }
    }
